...
public class kn
{
    // the data
        ...
        public static void main(String args[]){
            ...
            cityList.add(new City(instances[0],"high"));
            cityList.add(new City(instances[1],"high"));
            cityList.add(new City(instances[2],"normal"));
            cityList.add(new City(instances[3],"medium"));
            cityList.add(new City(instances[4],"low"));
            cityList.add(new City(instances[5],"normal"));
